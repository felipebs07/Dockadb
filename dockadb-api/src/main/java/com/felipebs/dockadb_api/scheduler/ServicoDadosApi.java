...
public class ServicoDadosApi {
    ...
    @Autowired
    private PaisService estadoService;


    String url = "https://servicodados.ibge.gov.br/api/v1/localidades/paises?lang=pt-br";
    ...
    public void salvarPaisScheduler() throws ServicoDadosApiException {
        try {
            ...
            if (response.statusCode() == 200) {
                var mapJson = JsonUtil.convertJsonToMap(response.body());
